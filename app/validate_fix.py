...
df = pd.read_csv(DATA_DIR / 'recotrip_places_with_clusters.csv')
kmeans = joblib.load(DATA_DIR / 'recotrip_kmeans_model.pkl')
encoders = joblib.load(DATA_DIR / 'recotrip_encoders.pkl')
season_encoder = joblib.load(DATA_DIR / 'recotrip_season_encoder.pkl')
age_encoder = joblib.load(DATA_DIR / 'recotrip_age_encoder.pkl')
scaler = joblib.load(DATA_DIR / 'recotrip_scaler.pkl')
